...
namespace Synergy.WPF.Common.Animations
{
	...
	public static class FrameworkElementAnimations
	{
		...
		public static void MarqueeAsync(this FrameworkElement element, float seconds = 3f)
		{
			...
			Synergy.Core.ProgramEnvironment.Instance.TaskManager.Run(async () =>
			{
				...
				while (element != null && !unloaded)
				{
					...
					try
					{
						...
						innerWidth = ((element as System.Windows.Controls.Border).Child as FrameworkElement).ActualWidth;
					}
					catch
					{
